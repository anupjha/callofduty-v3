...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen md:bg-slate-50">
      <Head>
        <title>Forgot Password | Call of duty</title>
      </Head>
      ...
      <main className="py-12">
        <div className="w-80 mx-auto md:w-96">
          ...
          <div className="md:rounded md:bg-white md:shadow-lg md:p-8">
            <h1 className="font-semibold text-center text-slate-600 mb-6">Can&lsquo;t sign in?</h1>
            <Formik
              initialValues={{
                email: "",
              }}
                ...
                <>
                  {isSubmitting ? (
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="mb-4">
                        <p className="text-xs text-slate-600 font-semibold mb-2">We&lsquo;ll send a recovery link to</p>
                        <Input
                          className="w-full"
                          type="email"
                          name="email"
            ...
            <Link href="/auth/signin">
              <a>
                <p className="text-xs text-blue-700 text-center">Return to sign in</p>
              </a>
            </Link>
          </div>
        </div>
