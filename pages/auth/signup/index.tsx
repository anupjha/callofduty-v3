...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen md:bg-slate-50">
      <Head>
        <title>Sign Up | Call of duty</title>
      </Head>
      ...
      <main className="py-12">
        <div className="w-80 mx-auto md:w-96">
          <div className="flex justify-center mb-6">
            <Link href="/">
              <a>
                <Image src="/images/logo-black.png" alt="Call of duty logo" width={240} height={64} />
              </a>
            </Link>
          </div>
          <div className="md:rounded md:bg-white md:shadow-lg md:p-8">
            <h1 className="font-semibold text-center text-slate-600 mb-6">Sign up for your account</h1>
            <Formik
              initialValues={{
                fullname: "",
                username: "",
                ...
                <>
                  {isSubmitting ? (
                    <div className="flex justify-center py-4">
                      <Loading height={36} width={4} radius={8} margin={2} color="rgb(29 78 216)" />
                    </div>
                  ) : (
                    <form onSubmit={handleSubmit}>
                      ...
                      <p className="text-xs text-slate-500 leading-normal mb-8 px-2">
                        ...
                        <Link href="/">
                          <a className="text-blue-700">Call of duty Terms of Service</a>
                        </Link>{" "}
                        and acknowledge the{" "}
                        <Link href="/">
            ...
            <Link href="/auth/signin">
              <a>
                <p className="text-xs text-blue-700 text-center">Already have an account? Sign in</p>
              </a>
            </Link>
          </div>
          <p className="text-xs text-slate-500 text-center leading-normalm mt-8">
            This page is protected by reCAPTCHA and the Google{" "}
            <a href="https://www.google.com/policies/privacy/" className="text-blue-700">
              Privacy Policy
            </a>
            and{" "}
            <a href="https://www.google.com/policies/terms/" className="text-blue-700">
              Terms of Service
            </a>{" "}
            apply
          </p>
