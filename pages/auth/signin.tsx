...
const SignInPage = () => {
  ...
  return (
    <div className="min-h-screen md:bg-slate-50">
      <Head>
        <title>Sign In | Call of duty</title>
      </Head>
      ...
      <main className="py-12">
        <div className="w-80 mx-auto md:w-96">
          ...
          <div className="md:rounded md:bg-white md:shadow-lg md:p-8">
            <h1 className="font-semibold text-center text-slate-600 mb-6">Sign in to Call of duty</h1>
            <Formik
              initialValues={{
                email: "",
                password: "",
                ...
                <>
                  {isSubmitting ? (
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      >
                        <Image src="/images/logo-google.png" alt="Google Logo" width={16} height={16} />
            ...
            <div className="flex justify-center items-center">
              <Link href="/auth/forgot-password">
                <a>
                  <p className="text-xs text-blue-700 text-center">Can&lsquo;t sign in?</p>
                </a>
              </Link>
              <span className="mx-3 text-slate-600">&#8226;</span>
              <Link href="/auth/signup">
                <a>
                  <p className="text-xs text-blue-700 text-center">Sign up for an account</p>
                </a>
              </Link>
            </div>
          </div>
