    ...
    <div className="min-h-screen">
      ...
      {isProcessing ? (
        <div className="w-full h-screen flex justify-center items-center">
          <Loading height={72} width={8} radius={16} margin={4} color="rgb(29 78 216)" />
        </div>
      ) : (
        <>
          {/* Header */}
          <header ref={refHeader} className="flex items-center px-4 py-2 fixed w-full">
            <Image src="/images/logo-black.png" alt="Call of duty Logo" width={128} height={64} />
            <Link href="/auth/signin">
              <a className="text-xs font-semibold text-slate-700 ml-auto mr-4">Sign In</a>
            </Link>
              ...
              <div className="flex flex-col items-center px-4 lg:items-start lg:px-16">
                <div className="max-w-[560px] md:max-w-3xl lg:max-w-2xl">
                  <h1 className="font-semibold text-3xl text-center mb-4 text-slate-700 md:text-5xl md:text-left">
                    Call of duty helps teams move work forward.
                  </h1>
                  <p className="text-center text-lg text-slate-700 mb-8 md:text-left md:mb-12">
                    ...
                    the way your team works is unique—accomplish it all with Call of duty.
                  </p>
                  <Link href="/auth/signup">
            ...
            <div className="flex justify-center px-4 py-16 lg:py-32">
              <div className="flex flex-col items-center max-w-[560px] md:max-w-3xl">
                ...
                <p className="text-center text-lg text-slate-700 mb-8 md:mb-12">
                  Start with a Call of duty board, lists, and cards. Customize and expand with more features as your
              ...
              <div className="w-full max-w-md flex flex-col items-center rounded px-4 py-12 bg-gradient-to-b from-blue-500 to-cyan-500 md:max-w-3xl">
                <div className="max-w-[560px]">
                  <p className="text-center text-white text-lg font-semibold mb-8 md:text-2xl">
                    Sign up and get started with Call of duty today. A world of productive teamwork awaits!
                  </p>
                  <Link href="/auth/signup">
                    <a className="w-full">
                      <Button
          ...
          <footer className="flex flex-col items-center pb-16">
            <Image className="grayscale" src="/images/logo-black.png" alt="Call of duty Logo" width={160} height={64} />
            <p className="text-slate-700">&copy; Copyright {year}. All rights reserved.</p>
          </footer>
        </>
      )}
    </div>
