...
const DashboardPage: NextPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="min-h-full">
        {boardsQuery.status === "success" && (
          <div className="px-8 pt-12 pb-32 w-full mx-auto sm:w-5/6">
            <h1 className="text-2xl font-semibold text-slate-600 mb-8">My Boards</h1>
      ...
      <ModalCreateBoard onRequestClose={() => setIsCreateBoardOpen(false)} isOpen={isCreateBoardOpen} />
    </Layout>
  );
};
